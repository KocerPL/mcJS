...
class Matrix3 {
    ...
    multiplyVec(vec) {
        let outVec;
        let col1 = new Vector3_js_1.Vector3(this._data[0], this._data[3], this._data[6]);
        let col2 = new Vector3_js_1.Vector3(this._data[1], this._data[4], this._data[7]);
        let col3 = new Vector3_js_1.Vector3(this._data[2], this._data[5], this._data[8]);
