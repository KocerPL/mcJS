...
exports.Main = exports.getUUID = void 0;
...
class Main {
    static world = new World_1.World(__dirname);
    static app = express();
    static server = http.createServer(this.app);
    static io = new Server(this.server);
    static gen = new Generator_1.Generator();
    static netHandler = new NetworkHandler_1.NetworkHandler(this.io);
    static entityManager = new EntityManager_1.EntityManager();
    static playersInfo = JSON.parse(fs.readFileSync(__dirname + "/players.json").toString());
    static run() {
